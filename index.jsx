...
const caseStudies = [
  {
    ...
    images: Array.from({ length: 7 }, (_, i) => `TriZen-Studio/public/img/TravelManagement (${i + 1}).png`)  
  },
  {
    ...
    images: Array.from({ length: 7 }, (_, i) => `TriZen-Studio/public/img/PortFolio (${i + 1}).png`)  
  },
  {
    ...
    images: Array.from({ length: 7 }, (_, i) => `TriZen-Studio/public/img/TrustNest.png`)  
  },
];
...
<div className="brand-mark" style={{ background: 'transparent' }}>
  <img src="TriZen-Studio/public/img/Logo.png" alt="TriZen Logo" style={{ width: '160%', height: '160%', objectFit: 'contain' }} />
          ...
          <div className="container">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: '20px' }}>
              <div className="pricing-card" data-reveal style={{ '--delay': '0ms' }}>
                <div className="pricing-icon pricing-laptop"><img src="TriZen-Studio/public/img/laptop.png" alt="Basic Laptop" /></div>
                <h3>Basic Plan</h3>
              ...
              <div className="pricing-card" data-reveal style={{ '--delay': '90ms' }}>
                <div className="pricing-icon"><img src="TriZen-Studio/public/img/star.png" alt="Business Car" /></div>
                <h3>Business Core</h3>
              ...
              <div className="pricing-card" data-reveal style={{ '--delay': '180ms' }}>
                <div className="pricing-icon"><img src="TriZen-Studio/public/img/crown.png" alt="Advanced Crown" /></div>
